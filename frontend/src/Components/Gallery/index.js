    ...
    <>
      <Wrapper>
        <GalleryWrapper>
          ...
          <Text>Photos and videos also accessible through: <Link style={{ textDecoration: 'none', color: '#114b5f', fontWeight: 'bold' }} to="https://photos.google.com">Google Photos</Link></Text>
          <GalleryListTopRow>
            {mediaItems
